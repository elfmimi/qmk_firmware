...
KC_LCTL, KC_LGUI, MO(1),   KC_LALT, KC_SPC, KC_SPC, KC_RALT, MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT \
	 ),
  LAYOUT(
RESET, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_INS, KC_DEL, KC_PSCR,\
...
_______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______, _______, _______, RGB_VAI, KC_PAUS, \
